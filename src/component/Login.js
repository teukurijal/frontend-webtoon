      ...
      <View style={styles.center}>
        ...
        <View style={styles.textcontainer}>
          ...
          <View style={styles.passwordcontainer}>
            ...
            { this.state.showPass
            ? <Icon style={{padding: 15}} name="eye-with-line" size={20} color="#000000" />
            : <Icon style={{padding: 15}} name="eye" size={20} color="#000000" /> }
            </TouchableOpacity>
            </View>
          ...
          <View>
            ...
            <TouchableOpacity style={styles.textcontainer} onPress={() => this.props.navigation.navigate('Register')}>
                <Text style={{fontSize: 12, letterSpacing: 2}}>don't have an account?
                <Text style={{color:'#1BB4D3', fontWeight:'700'}}> Register here</Text></Text>
            </TouchableOpacity>
            <TouchableOpacity style={{justifyContent:'center', alignItems:'center',top:25}} 
