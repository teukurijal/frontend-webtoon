...
export default class EditProfileScreen extends Component {
  ...
  static navigationOptions = ({ navigation, screenProps }) => ({
    ...
    headerLeft: null,
    headerRight: <Icon name="check" style={{marginRight:20,fontSize:25}} 
    onPress={()=>this.handleUpload()}  />  // () => navigation.navigate('ProfileScreen') 
  });
...
//   }
  ...
  render() {
    ...
    return (
        ...
        <Image style={{width:165, height: 165, borderRadius: 200/2, overflow: "hidden", borderWidth: 3,borderColor: "black"}} source={{uri: photo.uri}} />
        </View>
        <View style={{flexDirection:'row',justifyContent:'center'}}>
       
        <TouchableOpacity style={{bottom:25, left:68}}>
        <Icon  name="camera" size={25}   color="#000000" onPress={this.handleProfile.bind(this)} />
        </TouchableOpacity>
      </View>
